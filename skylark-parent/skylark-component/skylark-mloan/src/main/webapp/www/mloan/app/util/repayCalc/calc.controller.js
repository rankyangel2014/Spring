...
angular
    ...
    .controller('util.repayCalc.CalcCtrl', [
        ...
        function (
            ...
            self.repayTyp = $stateParams.repayTyp;
            ...
            */
            ...
            var calc = function () {
                ...
                jnStorage.temp.set('NEW_REPAY_LIST_DATA', returnData);
                                ...
                                if (calc()) {
                                    $state.go('utilRepayCalcResult', {
                                        ...
                                        setlDt: jnForm.rspDateFromJsDate(
                                            self.form.setlDt),
                                        setlTyp: self.form.setlTyp,
                                        schedAdjTyp: self.form.schedAdjTyp,
                                        loanNo: $stateParams.loanNo,
                                        aheadSetlPrcp:self.form.aheadSetlPrcp
                                    }, {
                                        reload: true,
                                    });
                                }
