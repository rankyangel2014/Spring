(function () {
    ...
    angular
        ...
        .controller('ContactsListCtrl', [
            '$state', '$stateParams', '$scope','jnContactsService','jnStorage',
            function ($state, $stateParams, $scope,jnContactsService,jnStorage) {
        ...
        .controller('ContactsViewCtrl', [
            '$state', '$stateParams', '$scope','jnContactsService','$filter','jnStorage',
            function ($state, $stateParams, $scope,jnContactsService,$filter,jnStorage) {
                $scope.title='通讯录详情';
